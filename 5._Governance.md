...
**2.3. Editors.** "Editors" are responsible for ensuring that the contents of specifications edited by the Working Group are complete, coherent, and adhere to applicable formatting and content guidelines. The Core Team will designed one or more Editors for each specification document edited by the Working Group.
